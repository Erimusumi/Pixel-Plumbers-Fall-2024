...
public class SwimmingLeftFireMario : IMarioSprite
{
    ...
    public SwimmingLeftFireMario(Texture2D MarioTexture)
    {
        ...
        FrameRectangles[0] = new Rectangle(180, 158, 16, 29); // Frame 1
        FrameRectangles[1] = new Rectangle(152, 158, 16, 29); // Frame 2
        FrameRectangles[2] = new Rectangle(127, 158, 16, 29);  // Frame 3
        FrameRectangles[3] = new Rectangle(103, 158, 14, 30); // Frame 4
        FrameRectangles[4] = new Rectangle(78, 158, 14, 30); // Frame 5
        FrameRectangles[5] = new Rectangle(52, 158, 16, 30);  // Frame 6
