...
public class SwimmingRightBig : ICharacter
{
    ...
    public SwimmingRightBig(Texture2D characterTexture)
    {
        ...
        FrameRectangles[0] = new Rectangle(209, 88, 16, 29); // Frame 1
        FrameRectangles[1] = new Rectangle(237, 88, 16, 29); // Frame 2
        FrameRectangles[2] = new Rectangle(262, 88, 16, 29);  // Frame 3
        FrameRectangles[3] = new Rectangle(288, 88, 14, 30); // Frame 4
        FrameRectangles[4] = new Rectangle(313, 88, 14, 30); // Frame 5
        FrameRectangles[5] = new Rectangle(337, 88, 16, 30);  // Frame 6
