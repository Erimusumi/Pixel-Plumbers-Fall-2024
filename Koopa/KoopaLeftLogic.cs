...
public class KoopaLeftLogic
{
    public void Updates(KoopaFields vars)
    {
        ...
        if (vars.counter == 0)
        {
            vars.sourceRectangle = new Rectangle(vars.leftXOne, vars.rightY, vars.width, vars.height);
        ...
        if ((vars.counter >= vars.countStart) && (vars.counter < vars.countEnd))
        {
            ...
            {
                vars.sourceRectangle = new Rectangle(vars.leftXTwo, vars.rightY, vars.width, vars.height);
            }
            else
            {
                vars.sourceRectangle = new Rectangle(vars.leftXOne, vars.rightY, vars.width, vars.height);
